...
1. [Φτιάξτε το βιογραφικό σας σε ψηφιακή και φυσική μορφή](https://github.com/courses-ionio/projects/blob/master/cv/index.md): Ατομική εργασία για την εκμάθηση της ροής εργασίας του Github.

2. [Συνεργατική κατασκευή της ιστοσελίδας του τμήματος](https://github.com/ioniodi/site-gr): Ομαδική εργασία.
